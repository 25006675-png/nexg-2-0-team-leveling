...
const SuccessScreen: React.FC<SuccessScreenProps> = ({ onReset, beneficiary }) => {
      ...
      <div className="flex flex-col items-center md:flex-row md:items-center md:gap-8 mb-8">
          ...
          <div className="relative shrink-0">
            <motion.div 
              ...
              className="w-24 h-24 rounded-full flex items-center justify-center shadow-xl z-10 relative bg-green-500 shadow-green-500/30"
            >
            ...
            <motion.div 
              ...
              className="absolute inset-0 rounded-full z-0 bg-green-500"
            />
          </div>
      ...
      <div className="w-full bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden mb-8 relative md:w-full">
         ...
         <div className="p-8 space-y-6">
            <div className="flex justify-between items-center pb-6 border-b-2 border-gray-100 border-dashed">
              ...
              <span className="text-base font-mono font-bold text-gov-900">TXN-{Math.floor(Math.random() * 10000)}-XJ2</span>
            </div>
